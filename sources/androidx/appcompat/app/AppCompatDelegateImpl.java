...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static class Api24Impl {
        ...
        static void generateConfigDelta_locale(Configuration configuration, Configuration configuration2, Configuration configuration3) {
            LocaleList m = DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration);
            LocaleList m2 = DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration2);
            if (!m.equals(m2)) {
    ...
    static class Api26Impl {
        ...
        static void generateConfigDelta_colorMode(Configuration configuration, Configuration configuration2, Configuration configuration3) {
            if ((DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration) & 3) != (DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration2) & 3)) {
                configuration3.colorMode = DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration3) | (DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration2) & 3);
            }
            if ((DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration) & 12) != (DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration2) & 12)) {
                configuration3.colorMode = DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration3) | (DialogCompat$$ExternalSyntheticApiModelOutline0.m(configuration2) & 12);
            }
        }
    }
}
