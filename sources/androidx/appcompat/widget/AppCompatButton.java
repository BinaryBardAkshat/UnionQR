    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatButton> {
        ...
        public void readProperties(AppCompatButton appCompatButton, PropertyReader propertyReader) {
            if (this.mPropertiesMapped) {
                ...
                propertyReader.readObject(this.mDrawableTintId, DialogCompat$$ExternalSyntheticApiModelOutline0.m(appCompatButton));
                propertyReader.readObject(this.mDrawableTintModeId, DialogCompat$$ExternalSyntheticApiModelOutline0.m(appCompatButton));
                return;
            }
