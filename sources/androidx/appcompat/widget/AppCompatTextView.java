    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatTextView> {
        ...
        public void readProperties(AppCompatTextView appCompatTextView, PropertyReader propertyReader) {
            if (this.mPropertiesMapped) {
                ...
                propertyReader.readObject(this.mDrawableTintId, DialogCompat$$ExternalSyntheticApiModelOutline0.m(appCompatTextView));
                propertyReader.readObject(this.mDrawableTintModeId, DialogCompat$$ExternalSyntheticApiModelOutline0.m(appCompatTextView));
                return;
            }
            throw DialogCompat$$ExternalSyntheticApiModelOutline0.m();
        }
    }
