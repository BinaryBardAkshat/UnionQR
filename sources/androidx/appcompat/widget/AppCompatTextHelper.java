...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (str2 != null) {
            boolean unused = this.mView.setFontVariationSettings(str2);
        }
        if (str != null) {
            if (Build.VERSION.SDK_INT >= 24) {
                this.mView.setTextLocales(DialogCompat$$ExternalSyntheticApiModelOutline0.m(str));
            } else {
        ...
        if (AutoSizeableTextView.PLATFORM_SUPPORTS_AUTOSIZE && this.mAutoSizeTextHelper.getAutoSizeTextType() != 0) {
            ...
            if (autoSizeTextAvailableSizes.length > 0) {
                if (((float) DialogCompat$$ExternalSyntheticApiModelOutline0.m(this.mView)) != -1.0f) {
    ...
    public void onSetTextAppearance(Context context, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && obtainStyledAttributes.hasValue(R.styleable.TextAppearance_fontVariationSettings) && (string = obtainStyledAttributes.getString(R.styleable.TextAppearance_fontVariationSettings)) != null) {
            boolean unused = this.mView.setFontVariationSettings(string);
        }
        obtainStyledAttributes.recycle();
        Typeface typeface = this.mFontTypeface;
        if (typeface != null) {
