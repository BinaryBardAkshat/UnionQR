...
class AppCompatTextViewAutoSizeHelper {
    ...
    private static class Impl29 extends Impl23 {
        ...
        /* access modifiers changed from: package-private */
        public boolean isHorizontallyScrollable(TextView textView) {
            return DialogCompat$$ExternalSyntheticApiModelOutline0.m(textView);
        }

        /* access modifiers changed from: package-private */
        public void computeAndSetTextDirection(StaticLayout.Builder builder, TextView textView) {
            StaticLayout.Builder unused = builder.setTextDirection(DialogCompat$$ExternalSyntheticApiModelOutline0.m(textView));
        }
    }
    ...
    private StaticLayout createStaticLayoutForMeasuring(CharSequence charSequence, Layout.Alignment alignment, int i, int i2) {
        StaticLayout.Builder m = StaticLayout.Builder.obtain(charSequence, 0, charSequence.length(), this.mTempTextPaint, i);
        StaticLayout.Builder m$1 = m.setAlignment(alignment).setLineSpacing(this.mTextView.getLineSpacingExtra(), this.mTextView.getLineSpacingMultiplier()).setIncludePad(this.mTextView.getIncludeFontPadding()).setBreakStrategy(this.mTextView.getBreakStrategy()).setHyphenationFrequency(this.mTextView.getHyphenationFrequency());
        if (i2 == -1) {
            i2 = Integer.MAX_VALUE;
        }
        StaticLayout.Builder unused = m$1.setMaxLines(i2);
        try {
            this.mImpl.computeAndSetTextDirection(m, this.mTextView);
