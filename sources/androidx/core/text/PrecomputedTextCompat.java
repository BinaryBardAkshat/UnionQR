...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = TraceCompat$$ExternalSyntheticApiModelOutline0.m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
        ...
        public Params(PrecomputedText.Params params) {
            this.mPaint = TraceCompat$$ExternalSyntheticApiModelOutline0.m(params);
            this.mTextDir = TraceCompat$$ExternalSyntheticApiModelOutline0.m(params);
            this.mBreakStrategy = TraceCompat$$ExternalSyntheticApiModelOutline0.m(params);
        ...
        public boolean equalsWithoutTextDirection(Params params) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (!TraceCompat$$ExternalSyntheticApiModelOutline0.m(this.mPaint).equals(TraceCompat$$ExternalSyntheticApiModelOutline0.m(params.getTextPaint()))) {
                    return false;
                }
        ...
        public int hashCode() {
            if (Build.VERSION.SDK_INT >= 24) {
                return ObjectsCompat.hash(Float.valueOf(this.mPaint.getTextSize()), Float.valueOf(this.mPaint.getTextScaleX()), Float.valueOf(this.mPaint.getTextSkewX()), Float.valueOf(this.mPaint.getLetterSpacing()), Integer.valueOf(this.mPaint.getFlags()), TraceCompat$$ExternalSyntheticApiModelOutline0.m(this.mPaint), this.mPaint.getTypeface(), Boolean.valueOf(this.mPaint.isElegantTextHeight()), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency));
            }
        ...
        public String toString() {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                sb.append(", textLocale=" + TraceCompat$$ExternalSyntheticApiModelOutline0.m(this.mPaint));
            } else {
                sb.append(", textLocale=" + this.mPaint.getTextLocale());
            }
            sb.append(", typeface=" + this.mPaint.getTypeface());
            if (Build.VERSION.SDK_INT >= 26) {
                sb.append(", variationSettings=" + TraceCompat$$ExternalSyntheticApiModelOutline0.m(this.mPaint));
            }
    ...
    public PrecomputedText getPrecomputedText() {
        if (TraceCompat$$ExternalSyntheticApiModelOutline0.m((Object) this.mText)) {
            return TraceCompat$$ExternalSyntheticApiModelOutline0.m((Object) this.mText);
        }
        return null;
    }
