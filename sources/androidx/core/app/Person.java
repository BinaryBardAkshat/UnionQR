...
public class Person {
    ...
    public static Person fromAndroidPerson(android.app.Person person) {
        return new Builder().setName(Person$$ExternalSyntheticApiModelOutline0.m(person)).setIcon(Person$$ExternalSyntheticApiModelOutline0.m(person) != null ? IconCompat.createFromIcon(Person$$ExternalSyntheticApiModelOutline0.m(person)) : null).setUri(Person$$ExternalSyntheticApiModelOutline0.m$1(person)).setKey(Person$$ExternalSyntheticApiModelOutline0.m(person)).setBot(Person$$ExternalSyntheticApiModelOutline0.m(person)).setImportant(Person$$ExternalSyntheticApiModelOutline0.m$1(person)).build();
    }
    ...
    public android.app.Person toAndroidPerson() {
        return Person$$ExternalSyntheticApiModelOutline0.m().setName(getName()).setIcon(getIcon() != null ? getIcon().toIcon() : null).setUri(getUri()).setKey(getKey()).setBot(isBot()).setImportant(isImportant()).build();
    }
