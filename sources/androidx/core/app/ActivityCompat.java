...
public class ActivityCompat extends ContextCompat {
    ...
    public static Uri getReferrer(Activity activity) {
        if (Build.VERSION.SDK_INT >= 22) {
            return DialogCompat$$ExternalSyntheticApiModelOutline0.m(activity);
        }
    ...
    public static boolean isLaunchedFromBubble(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT == 30) {
            if (DialogCompat$$ExternalSyntheticApiModelOutline0.m(activity) == null || DialogCompat$$ExternalSyntheticApiModelOutline0.m(activity).getDisplayId() == 0) {
                return false;
            }
            return true;
