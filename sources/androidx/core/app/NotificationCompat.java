...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                this.mSmallIcon = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(notification);
            }
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    addPerson(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(it.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline0.m().getName())) {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:58:0x01c6  */
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) parcelable)) {
                return IconCompat.createFromIcon(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) parcelable));
            }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    messagingStyle = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(this.mUser.toAndroidPerson());
                } else {
                    NotificationCompat$$ExternalSyntheticApiModelOutline0.m$1();
                    messagingStyle = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(this.mUser.getName());
                }
        ...
        public static final class Message {
                    ...
                    if (bundle.containsKey(KEY_TEXT)) {
                        if (bundle.containsKey(KEY_TIMESTAMP)) {
                            if (bundle.containsKey(KEY_PERSON)) {
                                ...
                                person = Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                            }
            ...
            public android.app.Notification.MessagingStyle.Message toAndroidMessage() {
                /*
                    ...
                    androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m$2()
                ...
                L_0x001d:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m((java.lang.CharSequence) r1, (long) r4, (android.app.Person) r3)
                    goto L_0x0038
                L_0x0022:
                    androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m$2()
                    java.lang.CharSequence r1 = r6.getText()
                ...
                L_0x0034:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline0.m((java.lang.CharSequence) r1, (long) r4, (java.lang.CharSequence) r3)
                L_0x0038:
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public static Builder fromAndroidAction(Notification.Action action) {
                Builder builder;
                if (Build.VERSION.SDK_INT < 23 || NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action) == null) {
                    builder = new Builder(action.icon, action.title, action.actionIntent);
                } else {
                    builder = new Builder(IconCompat.createFromIcon(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action)), action.title, action.actionIntent);
                }
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    builder.mAllowGeneratedReplies = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    builder.setSemanticAction(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action));
                }
    ...
    public static final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                builder = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(icon, action.getTitle(), action.getActionIntent());
            } else {
    ...
    public static BubbleMetadata getBubbleMetadata(Notification notification) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BubbleMetadata.fromPlatform(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(notification));
        }
        return null;
    }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            z = action.getExtras().getBoolean("android.support.allowGeneratedReplies") || NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action);
        } else {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            i = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action);
        } else {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, m$1);
        }
        if (NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action) == null && action2.icon != 0) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, m$1);
        }
        if (NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(action));
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, m$1);
    }
    ...
    public static String getShortcutId(Notification notification) {
        if (Build.VERSION.SDK_INT >= 26) {
            return NotificationCompat$$ExternalSyntheticApiModelOutline0.m$1(notification);
        }
        return null;
    }
    ...
    public static LocusIdCompat getLocusId(Notification notification) {
        LocusId m;
        if (Build.VERSION.SDK_INT < 29 || (m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(notification)) == null) {
            return null;
        }
