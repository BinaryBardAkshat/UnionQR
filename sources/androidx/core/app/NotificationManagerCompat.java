...
public final class NotificationManagerCompat {
    ...
    public boolean areNotificationsEnabled() {
        if (Build.VERSION.SDK_INT >= 24) {
            return Person$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager);
        }
    ...
    public int getImportance() {
        return Build.VERSION.SDK_INT >= 24 ? Person$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager) : IMPORTANCE_UNSPECIFIED;
    }
    ...
    public void deleteNotificationChannel(String str) {
        if (Build.VERSION.SDK_INT >= 26) {
            Person$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager, str);
        }
    }
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            for (Object m : this.mNotificationManager.getNotificationChannels()) {
                NotificationChannel m2 = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(m);
                if (!collection.contains(DialogCompat$$ExternalSyntheticApiModelOutline0.m(m2)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(m2)))) {
                    Person$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager, DialogCompat$$ExternalSyntheticApiModelOutline0.m(m2));
                }
            }
        }
    }
    ...
    public NotificationChannel getNotificationChannel(String str) {
        if (Build.VERSION.SDK_INT >= 26) {
            return Person$$ExternalSyntheticApiModelOutline0.m(this.mNotificationManager, str);
        }
        return null;
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            for (NotificationChannelGroup m : getNotificationChannelGroups()) {
                NotificationChannelGroup m2 = NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) m);
                if (NotificationCompat$$ExternalSyntheticApiModelOutline0.m(m2).equals(str)) {
                    return m2;
                }
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                for (NotificationChannel m : notificationChannels) {
                    arrayList.add(new NotificationChannelCompat(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) m)));
                }
                return arrayList;
            }
        }
