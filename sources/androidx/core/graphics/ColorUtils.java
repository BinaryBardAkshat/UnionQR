...
public final class ColorUtils {
    ...
    public static Color compositeColors(Color color, Color color2) {
        if (Objects.equals(Insets$$ExternalSyntheticApiModelOutline0.m(color), Insets$$ExternalSyntheticApiModelOutline0.m(color2))) {
            if (!Objects.equals(Insets$$ExternalSyntheticApiModelOutline0.m(color2), Insets$$ExternalSyntheticApiModelOutline0.m(color))) {
                color = color.convert(Insets$$ExternalSyntheticApiModelOutline0.m(color2));
            }
            float[] m = Insets$$ExternalSyntheticApiModelOutline0.m(color);
            float[] m2 = Insets$$ExternalSyntheticApiModelOutline0.m(color2);
            float m3 = Insets$$ExternalSyntheticApiModelOutline0.m(color);
            float m4 = Insets$$ExternalSyntheticApiModelOutline0.m(color2) * (1.0f - m3);
            int m5 = Insets$$ExternalSyntheticApiModelOutline0.m(color2) - 1;
            float f = m3 + m4;
            m2[m5] = f;
            if (f > 0.0f) {
                m3 /= f;
            ...
            return Color.valueOf(m2, Insets$$ExternalSyntheticApiModelOutline0.m(color2));
        }
        throw new IllegalArgumentException("Color models must match (" + Insets$$ExternalSyntheticApiModelOutline0.m(color) + " vs. " + Insets$$ExternalSyntheticApiModelOutline0.m(color2) + ")");
    }
