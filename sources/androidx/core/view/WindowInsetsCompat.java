...
public class WindowInsetsCompat {
    ...
    private static class Impl28 extends Impl21 {
        ...
        /* access modifiers changed from: package-private */
        public DisplayCutoutCompat getDisplayCutout() {
            return DisplayCutoutCompat.wrap(ViewCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
        }

        /* access modifiers changed from: package-private */
        public WindowInsetsCompat consumeDisplayCutout() {
            return WindowInsetsCompat.toWindowInsetsCompat(ViewCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
        }
    ...
    private static class Impl29 extends Impl28 {
        ...
        public Insets getSystemGestureInsets() {
            if (this.mSystemGestureInsets == null) {
                this.mSystemGestureInsets = Insets.toCompatInsets(ViewCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
            }
    ...
    private static class Impl30 extends Impl29 {
        static final WindowInsetsCompat CONSUMED = WindowInsetsCompat.toWindowInsetsCompat(ViewCompat$$ExternalSyntheticApiModelOutline0.m());
        ...
        public Insets getInsetsIgnoringVisibility(int i) {
            return Insets.toCompatInsets(ViewCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets, TypeImpl30.toPlatformType(i)));
        }

        public boolean isVisible(int i) {
            return ViewCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets, TypeImpl30.toPlatformType(i));
        }
    }
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builder = ViewCompat$$ExternalSyntheticApiModelOutline0.m(windowInsets);
            } else {
                builder = ViewCompat$$ExternalSyntheticApiModelOutline0.m();
            }
    ...
    private static final class TypeImpl30 {
        ...
        static int toPlatformType(int i) {
            ...
            for (int i4 = 1; i4 <= 256; i4 <<= 1) {
                if ((i & i4) != 0) {
                    if (i4 == 1) {
                        i2 = ViewCompat$$ExternalSyntheticApiModelOutline0.m();
                    } else if (i4 == 2) {
