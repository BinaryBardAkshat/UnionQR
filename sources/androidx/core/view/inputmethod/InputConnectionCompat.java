...
public final class InputConnectionCompat {
    ...
    public static boolean commitContent(InputConnection inputConnection, EditorInfo editorInfo, InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return inputConnection.commitContent(PrintHelper$$ExternalSyntheticApiModelOutline0.m(inputContentInfoCompat.unwrap()), i, bundle);
        }
            ...
            public boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
                if (Build.VERSION.SDK_INT >= 25 && (i & 1) != 0) {
                    try {
                        ...
                        InputContentInfo m = PrintHelper$$ExternalSyntheticApiModelOutline0.m(inputContentInfoCompat.unwrap());
                        bundle = bundle == null ? new Bundle() : new Bundle(bundle);
                        bundle.putParcelable(InputConnectionCompat.EXTRA_INPUT_CONTENT_INFO, m);
                    } catch (Exception e) {
