...
public final class MenuItemCompat {
    ...
    public static CharSequence getTooltipText(MenuItem menuItem) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return ViewCompat$$ExternalSyntheticApiModelOutline0.m(menuItem);
        }
        return null;
    }
    ...
    public static void setShortcut(MenuItem menuItem, char c, char c2, int i, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            MenuItem unused = menuItem.setShortcut(c, c2, i, i2);
        }
    }
    ...
    public static void setNumericShortcut(MenuItem menuItem, char c, int i) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            MenuItem unused = menuItem.setNumericShortcut(c, i);
        }
    }
    ...
    public static void setAlphabeticShortcut(MenuItem menuItem, char c, int i) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            MenuItem unused = menuItem.setAlphabeticShortcut(c, i);
        }
    }
