...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public static final AccessibilityActionCompat ACTION_MOVE_WINDOW = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 26 ? PrintHelper$$ExternalSyntheticApiModelOutline0.m$1() : null, 16908354, (CharSequence) null, (AccessibilityViewCommand) null, AccessibilityViewCommand.MoveWindowArguments.class);
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                accessibilityAction = PrintHelper$$ExternalSyntheticApiModelOutline0.m();
            } else {
    ...
    public boolean isImportantForAccessibility() {
        if (Build.VERSION.SDK_INT >= 24) {
            return ViewCompat$$ExternalSyntheticApiModelOutline0.m(this.mInfo);
        }
        return true;
    }
    ...
    public int getDrawingOrder() {
        if (Build.VERSION.SDK_INT >= 24) {
            return PrintHelper$$ExternalSyntheticApiModelOutline0.m(this.mInfo);
        }
        return 0;
    }
    ...
    public AccessibilityNodeInfoCompat getTraversalBefore() {
        if (Build.VERSION.SDK_INT >= 22) {
            return wrapNonNullInstance(PrintHelper$$ExternalSyntheticApiModelOutline0.m$1(this.mInfo));
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat getTraversalAfter() {
        if (Build.VERSION.SDK_INT >= 22) {
            return wrapNonNullInstance(PrintHelper$$ExternalSyntheticApiModelOutline0.m(this.mInfo));
        }
        return null;
    }
    ...
    public CharSequence getPaneTitle() {
        if (Build.VERSION.SDK_INT >= 28) {
            return ViewCompat$$ExternalSyntheticApiModelOutline0.m$1(this.mInfo);
        }
    ...
    public boolean isHeading() {
        if (Build.VERSION.SDK_INT >= 28) {
            return PrintHelper$$ExternalSyntheticApiModelOutline0.m$1(this.mInfo);
        }
    ...
    public TouchDelegateInfoCompat getTouchDelegateInfo() {
        ...
        if (Build.VERSION.SDK_INT < 29 || (m = PrintHelper$$ExternalSyntheticApiModelOutline0.m(this.mInfo)) == null) {
            return null;
        }
