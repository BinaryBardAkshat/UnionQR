...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        Person$$ExternalSyntheticApiModelOutline0.m$1();
        ShortcutInfo.Builder m = Person$$ExternalSyntheticApiModelOutline0.m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo m : list) {
            arrayList.add(new Builder(context, Person$$ExternalSyntheticApiModelOutline0.m((Object) m)).build());
        }
        return arrayList;
    }
    ...
    static LocusIdCompat getLocusId(ShortcutInfo shortcutInfo) {
        if (Build.VERSION.SDK_INT < 29) {
            return getLocusIdFromExtra(Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
        }
        if (Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo) == null) {
            return null;
        }
        return LocusIdCompat.toLocusIdCompat(Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, ShortcutInfo shortcutInfo) {
            ...
            this.mInfo = shortcutInfoCompat;
            shortcutInfoCompat.mContext = context;
            shortcutInfoCompat.mId = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPackageName = Person$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            Intent[] m = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf(m, m.length);
            shortcutInfoCompat.mActivity = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLabel = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLongLabel = Person$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            shortcutInfoCompat.mDisabledMessage = Person$$ExternalSyntheticApiModelOutline0.m$2(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 28) {
                shortcutInfoCompat.mDisabledReason = Person$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            } else {
                shortcutInfoCompat.mDisabledReason = shortcutInfo.isEnabled() ? 0 : 3;
            }
            shortcutInfoCompat.mCategories = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPersons = ShortcutInfoCompat.getPersonsFromExtra(Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
            shortcutInfoCompat.mUser = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLastChangedTimestamp = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 30) {
                shortcutInfoCompat.mIsCached = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            }
            shortcutInfoCompat.mIsDynamic = Person$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            shortcutInfoCompat.mIsPinned = Person$$ExternalSyntheticApiModelOutline0.m$2(shortcutInfo);
            ...
            shortcutInfoCompat.mRank = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mExtras = Person$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
        }
