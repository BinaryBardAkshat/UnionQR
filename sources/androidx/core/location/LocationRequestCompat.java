    ...
    public LocationRequest toLocationRequest(String str) {
        ...
        try {
            if (sCreateFromDeprecatedProviderMethod == null) {
                Method declaredMethod = TraceCompat$$ExternalSyntheticApiModelOutline0.m().getDeclaredMethod("createFromDeprecatedProvider", new Class[]{String.class, Long.TYPE, Float.TYPE, Boolean.TYPE});
                sCreateFromDeprecatedProviderMethod = declaredMethod;
                declaredMethod.setAccessible(true);
            }
            LocationRequest m = TraceCompat$$ExternalSyntheticApiModelOutline0.m(sCreateFromDeprecatedProviderMethod.invoke((Object) null, new Object[]{str, Long.valueOf(this.mIntervalMillis), Float.valueOf(this.mMinUpdateDistanceMeters), false}));
            if (m == null) {
                return null;
            }
            if (sSetQualityMethod == null) {
                Method declaredMethod2 = TraceCompat$$ExternalSyntheticApiModelOutline0.m().getDeclaredMethod("setQuality", new Class[]{Integer.TYPE});
                sSetQualityMethod = declaredMethod2;
                declaredMethod2.setAccessible(true);
            }
            sSetQualityMethod.invoke(m, new Object[]{Integer.valueOf(this.mQuality)});
            if (getMinUpdateIntervalMillis() != this.mIntervalMillis) {
                if (sSetFastestIntervalMethod == null) {
                    Method declaredMethod3 = TraceCompat$$ExternalSyntheticApiModelOutline0.m().getDeclaredMethod("setFastestInterval", new Class[]{Long.TYPE});
                    sSetFastestIntervalMethod = declaredMethod3;
                    declaredMethod3.setAccessible(true);
                }
                sSetFastestIntervalMethod.invoke(m, new Object[]{Long.valueOf(this.mMinUpdateIntervalMillis)});
            }
            if (this.mMaxUpdates < Integer.MAX_VALUE) {
                if (sSetNumUpdatesMethod == null) {
                    Method declaredMethod4 = TraceCompat$$ExternalSyntheticApiModelOutline0.m().getDeclaredMethod("setNumUpdates", new Class[]{Integer.TYPE});
                    sSetNumUpdatesMethod = declaredMethod4;
                    declaredMethod4.setAccessible(true);
                }
                sSetNumUpdatesMethod.invoke(m, new Object[]{Integer.valueOf(this.mMaxUpdates)});
            }
            if (this.mDurationMillis < Long.MAX_VALUE) {
                if (sSetExpireInMethod == null) {
                    Method declaredMethod5 = TraceCompat$$ExternalSyntheticApiModelOutline0.m().getDeclaredMethod("setExpireIn", new Class[]{Long.TYPE});
                    sSetExpireInMethod = declaredMethod5;
                    declaredMethod5.setAccessible(true);
                }
                sSetExpireInMethod.invoke(m, new Object[]{Long.valueOf(this.mDurationMillis)});
            }
            return m;
