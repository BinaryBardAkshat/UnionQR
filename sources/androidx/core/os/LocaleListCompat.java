...
public final class LocaleListCompat {
    ...
    public static LocaleListCompat wrap(Object obj) {
        return wrap(TraceCompat$$ExternalSyntheticApiModelOutline0.m(obj));
    }
    ...
    public static LocaleListCompat create(Locale... localeArr) {
        if (Build.VERSION.SDK_INT >= 24) {
            return wrap(TraceCompat$$ExternalSyntheticApiModelOutline0.m(localeArr));
        }
    ...
    public static LocaleListCompat getAdjustedDefault() {
        if (Build.VERSION.SDK_INT >= 24) {
            return wrap(TraceCompat$$ExternalSyntheticApiModelOutline0.m$1());
        }
    ...
    public static LocaleListCompat getDefault() {
        if (Build.VERSION.SDK_INT >= 24) {
            return wrap(TraceCompat$$ExternalSyntheticApiModelOutline0.m());
        }
        return create(Locale.getDefault());
    }
