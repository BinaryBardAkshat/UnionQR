...
public class SourceData {
    ...
    public ResultPoint translateResultPoint(ResultPoint resultPoint) {
        float x = (resultPoint.getX() * ((float) this.scalingFactor)) + ((float) this.cropRect.left);
        float y = (resultPoint.getY() * ((float) this.scalingFactor)) + ((float) this.cropRect.top);
    ...
    public Bitmap getBitmap(Rect rect, int i) {
        ...
        YuvImage yuvImage = new YuvImage(this.data.getData(), this.imageFormat, this.data.getWidth(), this.data.getHeight(), (int[]) null);
