...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        L_0x0083:
            ...
            int r1 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x01c1 }
            int r1 = r12.getDimensionPixelSize(r1, r10)     // Catch:{ all -> 0x01c1 }
            float r1 = (float) r1     // Catch:{ all -> 0x01c1 }
            r9.tabTextSize = r1     // Catch:{ all -> 0x01c1 }
            int r1 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x01c1 }
            android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r7, (android.content.res.TypedArray) r12, (int) r1)     // Catch:{ all -> 0x01c1 }
            r9.tabTextColors = r1     // Catch:{ all -> 0x01c1 }
            r12.recycle()
