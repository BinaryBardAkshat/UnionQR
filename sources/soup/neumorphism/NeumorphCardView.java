...
public final class NeumorphCardView extends FrameLayout {
    ...
    public /* synthetic */ NeumorphCardView(android.content.Context r1, android.util.AttributeSet r2, int r3, int r4, int r5, kotlin.jvm.internal.DefaultConstructorMarker r6) {
        /*
            r0 = this;
            r6 = r5 & 2
        ...
        L_0x0008:
            ...
            int r3 = soup.neumorphism.R.attr.neumorphCardViewStyle
        L_0x000e:
            r5 = r5 & 8
            if (r5 == 0) goto L_0x0014
            int r4 = soup.neumorphism.R.style.Widget_Neumorph_CardView
        L_0x0014:
            r0.<init>(r1, r2, r3, r4)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: soup.neumorphism.NeumorphCardView.<init>(android.content.Context, android.util.AttributeSet, int, int, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
