...
public final class NeumorphImageView extends AppCompatImageView {
    ...
    public /* synthetic */ NeumorphImageView(android.content.Context r1, android.util.AttributeSet r2, int r3, int r4, int r5, kotlin.jvm.internal.DefaultConstructorMarker r6) {
        /*
            r0 = this;
            r6 = r5 & 2
        ...
        L_0x0008:
            ...
            int r3 = soup.neumorphism.R.attr.neumorphImageViewStyle
        L_0x000e:
            r5 = r5 & 8
            if (r5 == 0) goto L_0x0014
            int r4 = soup.neumorphism.R.style.Widget_Neumorph_ImageView
        L_0x0014:
            r0.<init>(r1, r2, r3, r4)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: soup.neumorphism.NeumorphImageView.<init>(android.content.Context, android.util.AttributeSet, int, int, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
