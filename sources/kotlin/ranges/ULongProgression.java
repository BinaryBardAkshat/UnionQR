...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m191constructorimpl(j ^ ULong.m191constructorimpl(j >>> 32))) * 31) + ((int) ULong.m191constructorimpl(j2 ^ ULong.m191constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sb.append(ULong.m228toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m228toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m947fromClosedRange7ftBX0g(long j, long j2, long j3) {
