...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m946containsWZ4Q5Ns(((UInt) comparable).m165unboximpl());
    }

    public UInt getStart() {
        return UInt.m116boximpl(getFirst());
    }

    public UInt getEndInclusive() {
        return UInt.m116boximpl(getLast());
    }
    ...
    public String toString() {
        return UInt.m159toStringimpl(getFirst()) + ".." + UInt.m159toStringimpl(getLast());
    }
