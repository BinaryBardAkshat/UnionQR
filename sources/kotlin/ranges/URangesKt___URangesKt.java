...
class URangesKt___URangesKt {
    ...
    public static final UInt randomOrNull(UIntRange uIntRange, Random random) {
        ...
        return UInt.m116boximpl(URandomKt.nextUInt(random, uIntRange));
    }
    ...
    public static final ULong randomOrNull(ULongRange uLongRange, Random random) {
        ...
        return ULong.m185boximpl(URandomKt.nextULong(random, uLongRange));
    }

    /* renamed from: contains-biwQdVI  reason: not valid java name */
    private static final boolean m968containsbiwQdVI(UIntRange uIntRange, UInt uInt) {
        Intrinsics.checkParameterIsNotNull(uIntRange, "$this$contains");
        return uInt != null && uIntRange.m946containsWZ4Q5Ns(uInt.m165unboximpl());
    }

    /* renamed from: contains-GYNo2lE  reason: not valid java name */
    private static final boolean m964containsGYNo2lE(ULongRange uLongRange, ULong uLong) {
        Intrinsics.checkParameterIsNotNull(uLongRange, "$this$contains");
        return uLong != null && uLongRange.m948containsVKZWuLQ(uLong.m234unboximpl());
    }

    /* renamed from: contains-68kG9v0  reason: not valid java name */
    public static final boolean m963contains68kG9v0(UIntRange uIntRange, byte b) {
        Intrinsics.checkParameterIsNotNull(uIntRange, "$this$contains");
        return uIntRange.m946containsWZ4Q5Ns(UInt.m122constructorimpl(b & UByte.MAX_VALUE));
    }

    /* renamed from: contains-ULb-yJY  reason: not valid java name */
    public static final boolean m966containsULbyJY(ULongRange uLongRange, byte b) {
        Intrinsics.checkParameterIsNotNull(uLongRange, "$this$contains");
        return uLongRange.m948containsVKZWuLQ(ULong.m191constructorimpl(((long) b) & 255));
    }

    /* renamed from: contains-Gab390E  reason: not valid java name */
    public static final boolean m965containsGab390E(ULongRange uLongRange, int i) {
        Intrinsics.checkParameterIsNotNull(uLongRange, "$this$contains");
        return uLongRange.m948containsVKZWuLQ(ULong.m191constructorimpl(((long) i) & 4294967295L));
    }

    /* renamed from: contains-fz5IDCE  reason: not valid java name */
    public static final boolean m969containsfz5IDCE(UIntRange uIntRange, long j) {
        Intrinsics.checkParameterIsNotNull(uIntRange, "$this$contains");
        return ULong.m191constructorimpl(j >>> 32) == 0 && uIntRange.m946containsWZ4Q5Ns(UInt.m122constructorimpl((int) j));
    }

    /* renamed from: contains-ZsK3CEQ  reason: not valid java name */
    public static final boolean m967containsZsK3CEQ(UIntRange uIntRange, short s) {
        Intrinsics.checkParameterIsNotNull(uIntRange, "$this$contains");
        return uIntRange.m946containsWZ4Q5Ns(UInt.m122constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: contains-uhHAxoY  reason: not valid java name */
    public static final boolean m970containsuhHAxoY(ULongRange uLongRange, short s) {
        Intrinsics.checkParameterIsNotNull(uLongRange, "$this$contains");
        return uLongRange.m948containsVKZWuLQ(ULong.m191constructorimpl(((long) s) & 65535));
    }

    /* renamed from: downTo-Kr8caGY  reason: not valid java name */
    public static final UIntProgression m973downToKr8caGY(byte b, byte b2) {
        return UIntProgression.Companion.m945fromClosedRangeNkh28Cs(UInt.m122constructorimpl(b & UByte.MAX_VALUE), UInt.m122constructorimpl(b2 & UByte.MAX_VALUE), -1);
    }

    /* renamed from: downTo-J1ME1BU  reason: not valid java name */
    public static final UIntProgression m972downToJ1ME1BU(int i, int i2) {
        return UIntProgression.Companion.m945fromClosedRangeNkh28Cs(i, i2, -1);
    }

    /* renamed from: downTo-eb3DHEI  reason: not valid java name */
    public static final ULongProgression m974downToeb3DHEI(long j, long j2) {
        return ULongProgression.Companion.m947fromClosedRange7ftBX0g(j, j2, -1);
    }

    /* renamed from: downTo-5PvTz6A  reason: not valid java name */
    public static final UIntProgression m971downTo5PvTz6A(short s, short s2) {
        return UIntProgression.Companion.m945fromClosedRangeNkh28Cs(UInt.m122constructorimpl(s & UShort.MAX_VALUE), UInt.m122constructorimpl(s2 & UShort.MAX_VALUE), -1);
    }

    public static final UIntProgression reversed(UIntProgression uIntProgression) {
        Intrinsics.checkParameterIsNotNull(uIntProgression, "$this$reversed");
        return UIntProgression.Companion.m945fromClosedRangeNkh28Cs(uIntProgression.getLast(), uIntProgression.getFirst(), -uIntProgression.getStep());
    }

    public static final ULongProgression reversed(ULongProgression uLongProgression) {
        Intrinsics.checkParameterIsNotNull(uLongProgression, "$this$reversed");
        return ULongProgression.Companion.m947fromClosedRange7ftBX0g(uLongProgression.getLast(), uLongProgression.getFirst(), -uLongProgression.getStep());
    }
    ...
    public static final UIntRange m977untilKr8caGY(byte b, byte b2) {
        ...
        return new UIntRange(UInt.m122constructorimpl(b & UByte.MAX_VALUE), UInt.m122constructorimpl(UInt.m122constructorimpl(b3) - 1), (DefaultConstructorMarker) null);
    }
    ...
    public static final UIntRange m976untilJ1ME1BU(int i, int i2) {
        ...
        return new UIntRange(i, UInt.m122constructorimpl(i2 - 1), (DefaultConstructorMarker) null);
    }
    ...
    public static final ULongRange m978untileb3DHEI(long j, long j2) {
        ...
        return new ULongRange(j, ULong.m191constructorimpl(j2 - ULong.m191constructorimpl(((long) 1) & 4294967295L)), (DefaultConstructorMarker) null);
    }
    ...
    public static final UIntRange m975until5PvTz6A(short s, short s2) {
        ...
        return new UIntRange(UInt.m122constructorimpl(s & UShort.MAX_VALUE), UInt.m122constructorimpl(UInt.m122constructorimpl(s3) - 1), (DefaultConstructorMarker) null);
    }
    ...
    public static final int m959coerceInWZ9TVnA(int i, int i2, int i3) {
        if (UnsignedKt.uintCompare(i2, i3) > 0) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UInt.m159toStringimpl(i3) + " is less than minimum " + UInt.m159toStringimpl(i2) + '.');
    ...
    public static final long m961coerceInsambcqE(long j, long j2, long j3) {
        if (UnsignedKt.ulongCompare(j2, j3) > 0) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ULong.m228toStringimpl(j3) + " is less than minimum " + ULong.m228toStringimpl(j2) + '.');
    ...
    public static final byte m960coerceInb33U2AM(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UByte.m90toStringimpl(b3) + " is less than minimum " + UByte.m90toStringimpl(b2) + '.');
    }
    ...
    public static final short m958coerceInVKSA0NQ(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UShort.m323toStringimpl(s3) + " is less than minimum " + UShort.m323toStringimpl(s2) + '.');
    }

    /* renamed from: coerceIn-wuiCnnA  reason: not valid java name */
    public static final int m962coerceInwuiCnnA(int i, ClosedRange<UInt> closedRange) {
        Intrinsics.checkParameterIsNotNull(closedRange, "range");
        if (closedRange instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m116boximpl(i), (ClosedFloatingPointRange) closedRange)).m165unboximpl();
        }
        if (closedRange.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + closedRange + '.');
        } else if (UnsignedKt.uintCompare(i, closedRange.getStart().m165unboximpl()) < 0) {
            return closedRange.getStart().m165unboximpl();
        } else {
            return UnsignedKt.uintCompare(i, closedRange.getEndInclusive().m165unboximpl()) > 0 ? closedRange.getEndInclusive().m165unboximpl() : i;
        }
    }

    /* renamed from: coerceIn-JPwROB0  reason: not valid java name */
    public static final long m957coerceInJPwROB0(long j, ClosedRange<ULong> closedRange) {
        Intrinsics.checkParameterIsNotNull(closedRange, "range");
        if (closedRange instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m185boximpl(j), (ClosedFloatingPointRange) closedRange)).m234unboximpl();
        }
        if (closedRange.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + closedRange + '.');
        } else if (UnsignedKt.ulongCompare(j, closedRange.getStart().m234unboximpl()) < 0) {
            return closedRange.getStart().m234unboximpl();
        } else {
            return UnsignedKt.ulongCompare(j, closedRange.getEndInclusive().m234unboximpl()) > 0 ? closedRange.getEndInclusive().m234unboximpl() : j;
        }
    }
}
