...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m948containsVKZWuLQ(((ULong) comparable).m234unboximpl());
    }

    public ULong getStart() {
        return ULong.m185boximpl(getFirst());
    }

    public ULong getEndInclusive() {
        return ULong.m185boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m948containsVKZWuLQ(long j) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m191constructorimpl(getLast() ^ ULong.m191constructorimpl(getLast() >>> 32))) + (((int) ULong.m191constructorimpl(getFirst() ^ ULong.m191constructorimpl(getFirst() >>> 32))) * 31);
    }

    public String toString() {
        return ULong.m228toStringimpl(getFirst()) + ".." + ULong.m228toStringimpl(getLast());
    }
