...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object obj) {
        ...
        BaseContinuationImpl baseContinuationImpl2 = this;
        while (true) {
            DebugProbesKt.probeCoroutineResumed(baseContinuationImpl2);
            Continuation continuation = baseContinuationImpl2.completion;
            if (continuation == null) {
                Intrinsics.throwNpe();
            }
            try {
                Object invokeSuspend = baseContinuationImpl2.invokeSuspend(obj);
                if (invokeSuspend != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    if (continuation instanceof BaseContinuationImpl) {
                        baseContinuationImpl2 = (BaseContinuationImpl) continuation;
                    } else {
