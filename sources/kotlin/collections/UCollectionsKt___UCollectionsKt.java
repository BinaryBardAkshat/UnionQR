...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m98constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m109setVurrAj0(r0, i, r2.m96unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m167constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m178setVXSXFK8(r0, i, r2.m165unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        long[] r0 = ULongArray.m236constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m247setk8EXiF4(r0, i, r2.m234unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        short[] r0 = UShortArray.m331constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m342set01HTLdE(r0, i, r2.m329unboximpl());
            i++;
        }
        return r0;
    }
