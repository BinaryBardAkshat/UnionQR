...
public final class UArraysKt {
    ...
    public static final int m380random2D5oskM(int[] iArr, Random random) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UIntArray.m176isEmptyimpl(iArr)) {
            return UIntArray.m173getimpl(iArr, random.nextInt(UIntArray.m174getSizeimpl(iArr)));
        }
    ...
    public static final long m381randomJzugnMA(long[] jArr, Random random) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!ULongArray.m245isEmptyimpl(jArr)) {
            return ULongArray.m242getimpl(jArr, random.nextInt(ULongArray.m243getSizeimpl(jArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final byte m382randomoSF2wD8(byte[] bArr, Random random) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UByteArray.m107isEmptyimpl(bArr)) {
            return UByteArray.m104getimpl(bArr, random.nextInt(UByteArray.m105getSizeimpl(bArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final short m383randoms5X_as8(short[] sArr, Random random) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UShortArray.m340isEmptyimpl(sArr)) {
            return UShortArray.m337getimpl(sArr, random.nextInt(UShortArray.m338getSizeimpl(sArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final boolean m368contentEqualsctEhBpI(int[] iArr, int[] iArr2) {
    ...
    public static final boolean m371contentEqualsus8wMrg(long[] jArr, long[] jArr2) {
    ...
    public static final boolean m369contentEqualskdPth3s(byte[] bArr, byte[] bArr2) {
    ...
    public static final boolean m370contentEqualsmazbYpA(short[] sArr, short[] sArr2) {
    ...
    public static final int m372contentHashCodeajY9A(int[] iArr) {
    ...
    public static final int m374contentHashCodeQwZRm1k(long[] jArr) {
    ...
    public static final int m373contentHashCodeGBYM_sE(byte[] bArr) {
    ...
    public static final int m375contentHashCoderL5Bavg(short[] sArr) {
    ...
    public static final String m376contentToStringajY9A(int[] iArr) {
    ...
    public static final String m378contentToStringQwZRm1k(long[] jArr) {
    ...
    public static final String m377contentToStringGBYM_sE(byte[] bArr) {
    ...
    public static final String m379contentToStringrL5Bavg(short[] sArr) {
    ...
    public static final UInt[] m384toTypedArrayajY9A(int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$toTypedArray");
        int r0 = UIntArray.m174getSizeimpl(iArr);
        UInt[] uIntArr = new UInt[r0];
        for (int i = 0; i < r0; i++) {
            uIntArr[i] = UInt.m116boximpl(UIntArray.m173getimpl(iArr, i));
        }
        return uIntArr;
    }
    ...
    public static final ULong[] m386toTypedArrayQwZRm1k(long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$toTypedArray");
        int r0 = ULongArray.m243getSizeimpl(jArr);
        ULong[] uLongArr = new ULong[r0];
        for (int i = 0; i < r0; i++) {
            uLongArr[i] = ULong.m185boximpl(ULongArray.m242getimpl(jArr, i));
        }
        return uLongArr;
    }
    ...
    public static final UByte[] m385toTypedArrayGBYM_sE(byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$toTypedArray");
        int r0 = UByteArray.m105getSizeimpl(bArr);
        UByte[] uByteArr = new UByte[r0];
        for (int i = 0; i < r0; i++) {
            uByteArr[i] = UByte.m49boximpl(UByteArray.m104getimpl(bArr, i));
        }
        return uByteArr;
    }
    ...
    public static final UShort[] m387toTypedArrayrL5Bavg(short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$toTypedArray");
        int r0 = UShortArray.m338getSizeimpl(sArr);
        UShort[] uShortArr = new UShort[r0];
        for (int i = 0; i < r0; i++) {
            uShortArr[i] = UShort.m282boximpl(UShortArray.m337getimpl(sArr, i));
        }
        return uShortArr;
    }
}
