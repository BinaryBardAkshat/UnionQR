...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m404containsWZ4Q5Ns(((UInt) obj).m165unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m405indexOfWZ4Q5Ns(((UInt) obj).m165unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m406lastIndexOfWZ4Q5Ns(((UInt) obj).m165unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UIntArray.m174getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UIntArray.m176isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m404containsWZ4Q5Ns(int i) {
        return UIntArray.m169containsWZ4Q5Ns(this.$this_asList, i);
    }

    public UInt get(int i) {
        return UInt.m116boximpl(UIntArray.m173getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-WZ4Q5Ns  reason: not valid java name */
    public int m405indexOfWZ4Q5Ns(int i) {
        return ArraysKt.indexOf(this.$this_asList, i);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns  reason: not valid java name */
    public int m406lastIndexOfWZ4Q5Ns(int i) {
