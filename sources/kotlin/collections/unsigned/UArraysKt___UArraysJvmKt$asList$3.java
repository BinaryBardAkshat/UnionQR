...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m410contains7apg3OU(((UByte) obj).m96unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UByte) {
            return m411indexOf7apg3OU(((UByte) obj).m96unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UByte) {
            return m412lastIndexOf7apg3OU(((UByte) obj).m96unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UByteArray.m105getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UByteArray.m107isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-7apg3OU  reason: not valid java name */
    public boolean m410contains7apg3OU(byte b) {
        return UByteArray.m100contains7apg3OU(this.$this_asList, b);
    }

    public UByte get(int i) {
        return UByte.m49boximpl(UByteArray.m104getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-7apg3OU  reason: not valid java name */
    public int m411indexOf7apg3OU(byte b) {
        return ArraysKt.indexOf(this.$this_asList, b);
    }

    /* renamed from: lastIndexOf-7apg3OU  reason: not valid java name */
    public int m412lastIndexOf7apg3OU(byte b) {
