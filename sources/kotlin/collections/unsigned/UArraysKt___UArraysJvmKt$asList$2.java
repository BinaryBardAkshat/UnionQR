...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m407containsVKZWuLQ(((ULong) obj).m234unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m408indexOfVKZWuLQ(((ULong) obj).m234unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m409lastIndexOfVKZWuLQ(((ULong) obj).m234unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return ULongArray.m243getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return ULongArray.m245isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m407containsVKZWuLQ(long j) {
        return ULongArray.m238containsVKZWuLQ(this.$this_asList, j);
    }

    public ULong get(int i) {
        return ULong.m185boximpl(ULongArray.m242getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-VKZWuLQ  reason: not valid java name */
    public int m408indexOfVKZWuLQ(long j) {
        return ArraysKt.indexOf(this.$this_asList, j);
    }

    /* renamed from: lastIndexOf-VKZWuLQ  reason: not valid java name */
    public int m409lastIndexOfVKZWuLQ(long j) {
