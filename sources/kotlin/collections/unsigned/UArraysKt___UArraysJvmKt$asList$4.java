...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m413containsxj2QHRw(((UShort) obj).m329unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m414indexOfxj2QHRw(((UShort) obj).m329unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m415lastIndexOfxj2QHRw(((UShort) obj).m329unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UShortArray.m338getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UShortArray.m340isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public boolean m413containsxj2QHRw(short s) {
        return UShortArray.m333containsxj2QHRw(this.$this_asList, s);
    }

    public UShort get(int i) {
        return UShort.m282boximpl(UShortArray.m337getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-xj2QHRw  reason: not valid java name */
    public int m414indexOfxj2QHRw(short s) {
        return ArraysKt.indexOf(this.$this_asList, s);
    }

    /* renamed from: lastIndexOf-xj2QHRw  reason: not valid java name */
    public int m415lastIndexOfxj2QHRw(short s) {
