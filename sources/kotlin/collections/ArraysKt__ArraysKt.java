                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m455contentEqualsus8wMrg(((ULongArray) t).m251unboximpl(), ((ULongArray) t2).m251unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m452contentEqualsctEhBpI(((UIntArray) t).m182unboximpl(), ((UIntArray) t2).m182unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m454contentEqualsmazbYpA(((UShortArray) t).m346unboximpl(), ((UShortArray) t2).m346unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m453contentEqualskdPth3s(((UByteArray) t).m113unboximpl(), ((UByteArray) t2).m113unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m461contentToStringGBYM_sE(((UByteArray) t).m113unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m463contentToStringrL5Bavg(((UShortArray) t).m346unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m460contentToStringajY9A(((UIntArray) t).m182unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m462contentToStringQwZRm1k(((ULongArray) t).m251unboximpl()));
            } else {
