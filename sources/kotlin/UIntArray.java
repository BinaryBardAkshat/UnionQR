...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static int[] m168constructorimpl(int[] iArr) {
    ...
    public static boolean m171equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual((Object) iArr, (Object) ((UIntArray) obj).m182unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m172equalsimpl0(int[] iArr, int[] iArr2) {
    ...
    public boolean equals(Object obj) {
        return m171equalsimpl(this.storage, obj);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m181containsWZ4Q5Ns(((UInt) obj).m165unboximpl());
        }
        return false;
    }
    ...
    public static int[] m167constructorimpl(int i) {
        return m168constructorimpl(new int[i]);
    }

    /* renamed from: get-impl  reason: not valid java name */
    public static final int m173getimpl(int[] iArr, int i) {
        return UInt.m122constructorimpl(iArr[i]);
    }

    /* renamed from: set-VXSXFK8  reason: not valid java name */
    public static final void m178setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m174getSizeimpl(int[] iArr) {
        return iArr.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static UIntIterator m177iteratorimpl(int[] iArr) {
    ...
    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public static boolean m169containsWZ4Q5Ns(int[] iArr, int i) {
        return ArraysKt.contains(iArr, i);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m170containsAllimpl(int[] iArr, Collection<UInt> collection) {
        boolean z;
        ...
        for (Object next : iterable) {
            if (!(next instanceof UInt) || !ArraysKt.contains(iArr, ((UInt) next).m165unboximpl())) {
                z = false;
                continue;
            } else {
                z = true;
    ...
    public static boolean m176isEmptyimpl(int[] iArr) {
