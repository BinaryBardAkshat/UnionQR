...
public final class DurationKt {
    ...
    private static final double m1037timesmvk6XK0(int i, double d) {
        return Duration.m1019timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1036timeskIfJnKk(double d, double d2) {
        return Duration.m1018timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m992constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
