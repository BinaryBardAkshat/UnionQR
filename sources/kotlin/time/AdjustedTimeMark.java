...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m1015minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m989plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m1016plusLRDsOJo(this.adjustment, d), (DefaultConstructorMarker) null);
    }
}
