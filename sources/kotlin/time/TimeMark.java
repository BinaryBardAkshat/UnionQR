...
public abstract class TimeMark {
    ...
    public TimeMark m1041plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this, d, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1040minusLRDsOJo(double d) {
        return m1041plusLRDsOJo(Duration.m1033unaryMinusimpl(d));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1013isNegativeimpl(elapsedNow());
    }
