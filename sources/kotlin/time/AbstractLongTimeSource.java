...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public TimeMark m988plusLRDsOJo(double d) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1016plusLRDsOJo(this.offset, d), (DefaultConstructorMarker) null);
        }
    }
